        ...
        <div class="page-wrap">
            ...
            <div class="modal fade full-window-modal" id="fullwindowModal2" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="fullwindowModalLabel2">View  Report</h5>
                            <button type="button" class="close closemodal" data-dismiss="modal" aria-label="Close"><span
                                    aria-hidden="true">&times;</span></button>
                        </div>
                        <div class="modal-body edituserprofile">
                            ...
                            <div class="col-md-6">
                                <form action="report_get.php" method="POST">
                                    <label>Type of Report  </label>
                                    <select name="reportType" class="form-control">
                                    <option value="allHired">All Hired Dresses</option>
                                    <option value="moneyGenerated">Total Money Generated By Month</option>
                                    <option value="overDue">Total Money Generated By Month from Over Due Dress</option>
                                    </select>
                                    ...
                                    <input type="submit" name="submit_report" value="Generate Report" class="btn btn-primary" />
