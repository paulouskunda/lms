...
$selectUsers = "SELECT `userID`, `username`,`firstname`,`othername`,`lastname`,`identification_number`,`contact` FROM `users` WHERE `isActive` = 1";

$result = mysqli_query($database, $selectUsers);
    ...
    <div class="wrapper">
        ...
        <div class="page-wrap">
                        ...
                        <div class="card-header row">
                            <div class="col col-sm-3">
                                <div class="card-options d-inline-block">
                                    ...
                                    <a href="users.php" style="cursor: pointer;"><i class="ik ik-rotate-cw"></i></a>
                                </div>
                            </div>
                            ...
                            <table id="advanced_table" class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr id="<?php echo $row['userID'];?>">
                                        <td>
                                            <a class="viewuser" id="<?php echo $row['userID'];?>" data-toggle="modal"
                                                data-target="#modal-lg" style="cursor: pointer;"><i
                                                    class="ik ik-eye"></i></a>
                                            <a class="edituser" id="<?php echo $row['userID'];?>" data-toggle="modal"
                                                data-target="#fullwindowModal2" style="cursor: pointer;
                                            margin-left: 5px; margin-right: 5px;"><i class="ik ik-edit"></i></a>
                                            <a class="deleteuser" style="cursor: pointer; color:red;"
                                                id="<?php echo $row['userID'];?>"><i class="ik ik-x"></i></a>
                                        </td>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="fullwindowModalLabel">Register User</h5>
                                                ...
                                                <div class="card-body">
                                                    <div class="forms-sample">
                                                        <div class="form-group">
                                                            <label for="username">Username <small style="color:blue;">
                                                                    Username cannot contain number</small></label>
                                                            <input type="text" class="form-control" id="username"
                                                                title="Username cannot contain number"
                                                                onblur="checkifempty('username'); checkPattern('username'); checkuserexists()"
                                                    ...
                                                    <div class="forms-sample">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="role" id="role" class="form-control"
                                                                onchange="checkrolecombovalue()" required>
                                                                <option value=""></option>
                                                                <?php
                                                    if ($roleNum > 0) {
                                                        while ($row2 = mysqli_fetch_array($roleResult)) {
                                                            ?>
                                                                <option value="<?php echo $row2['roleID']; ?>">
                                                                    <?php echo $row2['role_title']; ?></option>
                                                                <?php
                                                        }
                                                    }
                                                    ?>
            ...
            $('#adduser').click(function() {
                ...
                if (username !== '' && firstname !== '' && lastname !== '' && nrc !== '' &&
